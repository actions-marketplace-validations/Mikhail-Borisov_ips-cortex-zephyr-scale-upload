...
exports.WrongParametersError = exports.UnknownError = exports.UnauthorizedError = exports.NotSupportedVersionError = exports.NotFoundError = void 0;
...
class NotSupportedVersionError extends Error {
    constructor(version) {
        super(`Zephyr Scale version ${version} is not supported. Supported versions: 1.0`);
    }
}
exports.NotSupportedVersionError = NotSupportedVersionError;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ZephyrScaleApi = void 0;
const errors_1 = __nccwpck_require__(482);
...
class ZephyrScaleApi {
    constructor(jiraBaseUrl, version, projectKey, bearerToken) {
    ...
    postTestCase(testCase) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.post('/testcase', testCase);
            switch (response.status) {
                case 201:
                    return response.data;
                case 401:
                    throw new errors_1.UnauthorizedError(response.data.status.message);
                case 400:
                    throw new errors_1.WrongParametersError(response.data.errorMessages);
                default:
    ...
    getTestCase(testCaseKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`/testcase/${testCaseKey}`);
            switch (response.status) {
                case 200:
                    return response.data;
                case 401:
                    throw new errors_1.UnauthorizedError(response.data.status.message);
                case 404:
                    throw new errors_1.NotFoundError('Test Case', testCaseKey);
                default:
                    throw new errors_1.UnknownError();
            }
        });
    }
    putTestCase(testCaseKey, testCase) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.put(`/testcase/${testCaseKey}`, testCase);
            switch (response.status) {
                case 200:
                    return;
                case 401:
    ...
    deleteTestCase(testCaseKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.delete(`/testcase/${testCaseKey}`);
            switch (response.status) {
                case 204:
                    return;
                case 401:
    ...
    getLatestTestExecution(testCaseKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`/testcase/${testCaseKey}/testresult/latest`);
            switch (response.status) {
                case 200:
                    return response.data;
                case 401:
                    throw new errors_1.UnauthorizedError(response.data.status.message);
                case 404:
                    throw new errors_1.NotFoundError('Test Case', testCaseKey); // Or Test Case has no results
                default:
                    throw new errors_1.UnknownError();
            }
        });
    }
    getTestCasesForIssue(issueKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`issuelink/${issueKey}/testcases`);
            switch (response.status) {
                case 200:
                    return response.data;
                case 401:
                    throw new errors_1.UnauthorizedError(response.data.status.message);
                case 404:
                    throw new errors_1.NotFoundError('Issue', issueKey);
                default:
                    throw new errors_1.UnknownError();
            }
        });
    }
    searchTestCases(query, startAt, maxResults) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`/testcase/search`, {
    ...
    // TEST CYCLE
    postTestCycle(testCycle) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.post('/testrun', testCycle);
            switch (response.status) {
                case 201:
                    return response.data;
                case 401:
    ...
    getTestCycle(testCycleKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`/testrun/${testCycleKey}`);
            switch (response.status) {
                case 200:
                    return response.data;
                case 401:
                    throw new errors_1.UnauthorizedError(response.data.status.message);
                case 404:
                    throw new errors_1.NotFoundError('Test Cycle', testCycleKey);
                default:
                    throw new errors_1.UnknownError();
            }
        });
    }
    deleteTestCycle(testCycleKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.delete(`/testrun/${testCycleKey}`);
            switch (response.status) {
                case 204:
                    return;
                case 401:
    ...
    searchTestCycles(query, startAt, maxResults) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`/testrun/search`, {
                params: { query, startAt, maxResults }
            });
            switch (response.status) {
                case 200:
    ...
    // Test Result
    postTestExecutionsForTestCycle(testCycleKey, testResults) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.post(`/testrun/${testCycleKey}/testresults`, testResults);
            switch (response.status) {
                case 201:
                    return response.data;
                case 401:
    ...
    getTestExecutionsForTestCycle(testCycleKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`/testrun/${testCycleKey}/testresults`);
            switch (response.status) {
                case 200:
                    return response.data;
                case 401:
    ...
    postTestExecutionForTestCycleAndTestCase(testCycleKey, testCaseKey, testResult) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.post(`/testrun/${testCycleKey}/testcase/${testCaseKey}/testresult`, testResult);
            switch (response.status) {
                case 201:
                    return response.data;
                case 401:
    ...
    putTestExecutionForTestCycleAndTestCase(testCycleKey, testCaseKey, testResult) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.put(`/testrun/${testCycleKey}/testcase/${testCaseKey}/testresult`, testResult);
            switch (response.status) {
                case 200:
                    return response.data;
                case 401:
    ...
    postTestExecution(testResult) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.post('/testresult', testResult);
            switch (response.status) {
                case 201:
                    return response.data;
                case 401:
    ...
    postTestPlan(testPlan) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.post('/testplan', testPlan);
            switch (response.status) {
                case 201:
                    return response.data;
                case 401:
    ...
    getTestPlan(testPlanKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`/testplan/${testPlanKey}`);
            switch (response.status) {
                case 200:
                    return response.data;
                case 401:
                    throw new errors_1.UnauthorizedError(response.data.status.message);
                case 404:
                    throw new errors_1.NotFoundError('Test Plan', testPlanKey);
                default:
                    throw new errors_1.UnknownError();
            }
        });
    }
    putTestPlan(testPlanKey, testPlan) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.put(`/testplan/${testPlanKey}`, testPlan);
            switch (response.status) {
                case 200:
                    return response.data;
                case 401:
    ...
    deleteTestPlan(testPlanKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.delete(`/testplan/${testPlanKey}`);
            switch (response.status) {
                case 204:
                    return;
                case 401:
    ...
    searchTestPlans(query, startAt, maxResults) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.axios.get(`/testplan/search`, {
                params: { query, startAt, maxResults }
            });
            switch (response.status) {
                case 200:
...
exports.ZephyrScaleApi = ZephyrScaleApi;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const testCycle = yield api.getTestCycle(testCycleKey);
            core.info(`Got info for Test Cycle ${testCycleKey}:\n${JSON.stringify(testCycle, null, 2)}`);
            if (testCycle.items !== undefined) {
                const testCasesInTestCycle = new Set(testCycle.items.map(item => item.testCaseKey));
                const executions = yield (0, utils_1.collectExecutions)(files);
                const executionsToUpload = executions.filter(execution => testCasesInTestCycle.has(execution.testCase.key));
                ...
                if (testResultsToUpload.length > 0) {
                    core.debug(`Test Executions:\n${JSON.stringify(testResultsToUpload, null, 2)}`);
                    yield api.postTestExecutionsForTestCycle(testCycleKey, testResultsToUpload);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.collectExecutions = exports.readZephyrScaleResult = void 0;
const core = __importStar(__nccwpck_require__(2186));
const fs = __importStar(__nccwpck_require__(7147));
const errors_1 = __nccwpck_require__(482);
function readZephyrScaleResult(path) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.readZephyrScaleResult = readZephyrScaleResult;
function collectExecutions(paths) {
    return __awaiter(this, void 0, void 0, function* () {
        const executions = [];
        for (const path of paths) {
            core.info(`Reading test report: ${path}`);
            const testReport = yield readZephyrScaleResult(path);
            if (testReport.version !== 1) {
                throw new errors_1.NotSupportedVersionError(testReport.version);
            }
            else {
...
exports.collectExecutions = collectExecutions;
